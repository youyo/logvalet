...
func RegisterSpaceTools(r *ToolRegistry, cfg ServerConfig) {
	// logvalet_space_info
	r.RegisterWithSpaces(gomcp.NewTool("logvalet_space_info",
	...
	r.RegisterWithSpaces(gomcp.NewTool("logvalet_space_digest",
	...
	r.RegisterWithSpaces(gomcp.NewTool("logvalet_space_disk_usage",
